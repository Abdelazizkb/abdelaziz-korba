...
function MyBlog() {
    ...
    return (
    <div className="container mx-auto 2xl:px-20 flex flex-wrap justify-center md:justify-around items-center md:mb-16">
        ...
        <div>
            <div className="">
                ...
                <div className="">
                    <p className="text-sm md:text-lg font-pop font-normal text-gray-700 mt-4">Blog post where users can sign in </p> 
                    <p className="text-sm md:text-lg font-pop font-normal text-gray-700 my-2">sign up and add new posts or</p> 
                    <p className="text-sm md:text-lg font-pop font-normal text-gray-700 my-2">delete/update thier posts</p> 
                </div>
